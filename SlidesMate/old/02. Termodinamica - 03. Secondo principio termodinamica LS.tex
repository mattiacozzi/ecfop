...
\frametitle{La macchina termica ideale}
  ...
  \begin{itemize}
    \item non soffre di fenomeni dissipativi, cioè avvengono solo trasformazioni ideali;\pause
    \item riceve una quantità di calore $ Q_2 $ da una \emph{sorgente calda} a temperatura $ T_2 $; ricevendo calore, \colorbox{blue!30}{$ Q_2 > 0 $};\pause
    \item cede una quantità di calore $ Q_1 $ ad una \emph{sorgente fredda} a temperatura $ T_1 < T_2 $; cedendo calore, \colorbox{blue!30}{$ Q_1 < 0 $}.
  \end{itemize}
\end{frame}
...
\draw [fill=black] (7,3) rectangle (10,3.1);
\draw [->,thick,red] (8.5,-.4) -- (8.5,1);
\draw [->,thick] (8.5,2.6) -- (8.5,4);
\node [right] at (8.5,3.6) {$ L $};
\node [right,red] at (8.5,.6) {$ Q_2 $};
\end{tikzpicture}
\end{figure} 
\pause
...
\begin{column}{.4\textwidth}
  \visible<3>{\begin{figure}
    \includegraphics[width=\columnwidth]{img/ciclo-frigorifero.png}
  \end{figure}}
\end{column}
\begin{column}{.4\textwidth}
...
\begin{frame}
\frametitle{Trasformazioni impossibili e trasformazioni possibili}
 $ Q_1 >0$ in quanto calore assorbito, $ Q_2 <0$ in quanto calore ceduto.\\~\\   
\begin{columns}
\begin{column}{0.4\textwidth}
Permessa da Clausius
\begin{figure}\centering
\begin{tikzpicture}[scale=0.35]
\node [above,purple] at (0,2) {M};
\draw [purple, ultra thick] (0,0) circle [radius=2];
...
\draw (-4,2) -- (-5.5,2);
\draw (-4,-2) -- (-5.5,-2);
\node [left,blue] at (-4,0) {$ T_1 $};

\draw (4,2) -- (4,-2);
\draw (4,2) -- (5.5,2);
\draw (4,-2) -- (5.5,-2);
\node [right,red] at (4,0) {$ T_2 $};
...
\draw [->,thick] (0,-4) -- (0,-2);
\node [right] at (0,-3) {$ L_e $};
\end{tikzpicture}
\end{figure}
\[ |Q_2| = Q_1 + L_e \]
\end{column}
\begin{column}{0.4\textwidth}
Proibita da Clausius
\begin{figure}\centering
\begin{tikzpicture}[scale=0.35]
\node [above,purple] at (0,2) {M};
\draw [purple, ultra thick] (0,0) circle [radius=2];
...
\begin{column}{0.3\textwidth}
  ...
  \begin{tikzpicture}[scale=0.4]
    \visible<3-6>{\draw[<->] (0,6) -- (0,0) -- (7,0);
    \node [above left] at (1,4.5) { {\footnotesize $ A $} };
    \draw[thick,line cap=round] (1,4.5) to[out=310,in=170] (4.5,2.5);
    \node [above right] at (4.5,2.5) {{\footnotesize $ B $}};}
    \visible<4-6>{\draw[thick,line cap=round] (4.5,2.5) to[out=280,in=110] (5,.5);
    \node [right] at (5,.5) {{\footnotesize $ C $}};}
    \visible<5-6>{\draw[thick,line cap=round] (5,.5) to[out=175,in=330] (1.5,1.5);
    \node [below left] at (1.5,1.5) {{\footnotesize $ D $}};}
    \visible<6>{\draw[thick,line cap=round] (1.5,1.5) to[out=105,in=275] (1,4.5);}
  \end{tikzpicture}
\end{figure}
\end{column}
\end{columns}
